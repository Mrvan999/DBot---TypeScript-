...
export function registroSendContainer() {
    return createContainer({
        components: [
            ...
            Separator.Large,
            createTextDisplay(brBuilder("Para realizar seu registro estatístico, clique no botão abaixo. Um formulário será exibido; preencha-o e você será registrado na Diretoria de Pessoal.")),
